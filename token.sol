...
contract ZuckerBucks is StandardToken {
    ...
    */
    ...
    function () external payable {
        ...
        giveaway_value = (starting_giveaway / giveaway_count) + (starting_giveaway / (giveaway_count + 2)) * (1 + (eth_val/1000000000000000000));
    ...
    constructor() ZuckerBucks (
        ...
        circulatingSupply = 0;
        name = "Zucker Bucks";                                   // Set the name for display purposes
